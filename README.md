...
- *Apple Silicon (*`arm64`*) **ONLY***: `alacritty` universal app manual build (requires `rustup-init`) ([guide](https://github.com/alacritty/alacritty/blob/master/INSTALL.md#universal-binary)) `pass`: run the install script then set your GPG keys and private passwords git repo (follow private notes)
